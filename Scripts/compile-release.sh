...
if [ $__AS != 0 ]; then
    ...
    __AF_prepare113_v0__56_5="$__AF_prepare113_v0";
    echo "$__AF_prepare113_v0__56_5" > /dev/null 2>&1
    build__114_v0 ;
    __AS=$?;
if [ $__AS != 0 ]; then
    ...
    __AF_build114_v0__60_5="$__AF_build114_v0";
    echo "$__AF_build114_v0__60_5" > /dev/null 2>&1
    __AMBER_VAL_4=$(pwd);
    __AS=$?;
    target_dir="${__AMBER_VAL_4}/${__1_release_folder}"
    __AMBER_LEN="${args[1]}";
...
if [ $__AS != 0 ]; then
        ...
        __AF_echo_error109_v0__70_9="$__AF_echo_error109_v0";
        echo "$__AF_echo_error109_v0__70_9" > /dev/null 2>&1
fi;
    __AF_extract115_v0__69_5="$__AF_extract115_v0";
    echo "$__AF_extract115_v0__69_5" > /dev/null 2>&1
    echo "[*] done build."
